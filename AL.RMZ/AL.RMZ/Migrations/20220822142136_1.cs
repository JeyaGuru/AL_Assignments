        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartReading = table.Column<int>(type: "int", nullable: false),
                    EndReading = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ElectricityMeterDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ElectricityMeterDetails_ElectricityMeters_ElectricityMeterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WaterMeterDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WaterMeterDetails_WaterMeters_WaterMeterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ElectricityMeterDetails_ElectricityMeterId",
                table: "ElectricityMeterDetails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WaterMeterDetails_WaterMeterId",
                table: "WaterMeterDetails",
                column: "WaterMeterId");
